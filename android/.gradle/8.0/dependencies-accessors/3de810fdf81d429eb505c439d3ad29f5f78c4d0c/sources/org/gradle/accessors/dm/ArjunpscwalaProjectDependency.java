...
@NonNullApi
public class ArjunpscwalaProjectDependency extends DelegatingProjectDependency {

    @Inject
    public ArjunpscwalaProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
